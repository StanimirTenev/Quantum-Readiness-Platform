...
- `POST /api/copilot/query`, `GET /api/copilot/narrate/{asset_name}`, `GET /api/copilot/discover`, `GET /api/copilot/vendor-intelligence`, `GET /api/copilot/migration-plan`, `GET /api/copilot/{plan-summary|workflow-summary|operational-summary}` (copilot-service, `COPILOT_SERVICE_URL`, default port 8008)
