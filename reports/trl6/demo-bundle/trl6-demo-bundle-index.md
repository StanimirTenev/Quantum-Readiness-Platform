...
UTC timestamp: 2026-05-17T05:42:24.392566+00:00
...
|---|---|---|---|---|---|---|
| trl6_readiness | trl6_readiness_report | `reports/trl6/trl6-readiness-report.md` | True | True | UNKNOWN | `fc9b33bedab9` |
...
| limitations | trl6_known_limitations | `reports/trl6/known-limitations.md` | True | True | UNKNOWN | `d5a58806c64d` |
...
| evidence_index | evidence_pack_index_json | `reports/evidence-pack/evidence-pack-index.json` | True | True | UNKNOWN | `50630b402d6a` |
| graph_validation | graph_api_readonly_smoke | `reports/graph/latest/graph-api-readonly-smoke-report.md` | False | True | PASS | `d22d4b0b4662` |
...
| copilot_validation | copilot_safety_contract_smoke | `reports/copilot/safety-contract-smoke-report.md` | False | True | UNKNOWN | `776e97b6d56b` |
| stage_validation | stage2_inventory_smoke | `reports/stage2-inventory-smoke-report.md` | False | True | UNKNOWN | `5337f5cf86ac` |
| stage_validation | stage2_e2e_smoke | `reports/stage2-e2e-smoke-report.md` | False | True | UNKNOWN | `3233d0d4108e` |
| stage_validation | stage3_risk_planning_smoke | `reports/stage3-risk-planning-smoke-report.md` | False | True | UNKNOWN | `c5cf5b4ccb68` |
| trl6_readiness | trl_validation_report | `reports/trl-validation-report.md` | True | True | PASS | `d9f16a3607f4` |
| repository_status | repository_checkpoint_status | `docs/repository-checkpoint-current-status.md` | True | True | UNKNOWN | `744485cbb14f` |
