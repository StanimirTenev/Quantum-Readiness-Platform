...
UTC timestamp: 2026-05-14T06:24:06.277115+00:00
...
| graph | graph_projection | `reports/graph/latest/graph-projection-report.md` | True | PASS | `c0a867c770ff` |
| graph | graph_snapshot_loader | `reports/graph/latest/graph-snapshot-loader-report.md` | True | PASS | `bdbb2026abf4` |
| graph | graph_api_readonly | `reports/graph/latest/graph-api-readonly-smoke-report.md` | True | PASS | `871f705a5ce9` |
| copilot | copilot_offline_smoke | `reports/copilot/offline-smoke-report.md` | True | PASS | `d51687f3ef9f` |
| copilot | copilot_safety_contract | `reports/copilot/safety-contract-smoke-report.md` | True | PASS | `3525d0402348` |
